...
export const Aside_Data: AsideItem = [
  ...
  // },
  {
   // image: 'https://www.taiyi.me/favicon.ico',
    promo: '太乙数衍',
    info1: '免费AI八字测算',
    info2: 'AI八字 <span class="promo-text"> 绝对免费 </span>',
    link: 'https://www.taiyi.me',
    rel: 'sponsored noreferrer'
  },
  {
    // image: 'https://www.taiyi.me/favicon.ico',
    ...
    info1: '精准解析生辰八字',
    info2: '揭示命盘奥秘',
    link: 'https://www.taiyi.me/bazi',
    rel: 'sponsored noreferrer'
  },
  {
    // image: 'https://www.taiyi.me/favicon.ico',
    promo: '太乙数衍 - 奇门遁甲',
    info1: '融合了天文、地理、历法等预测',
     info2: '分析人事、运势及环境变化',
    link: 'https://www.taiyi.me/qimen',
    rel: 'sponsored noreferrer'
  },
  {
    // image: { src: 'https://www.taiyi.me/favicon.ico', crop: true },
    promo: '太乙数衍 - 六爻排盘',
    info1: '结合干支、五行、六亲等元素构建卦象模型，并进行吉凶推演',
    link: 'https://taiyi.me/liuyao',
    rel: 'sponsored noreferrer'
  }
  // ,
  // {
